      ...
      <div class="timeline d-flex align-items-end">
        <div class="timeline-sidebar">
          ...
          <div
            ...
            @click="tab = 2"
          >
            <div class="ts-year">2018</div>
            <div class="ts-pos">IT Support</div>
          </div>
          <div
            class="ts-list pointer"
